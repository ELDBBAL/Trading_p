                ...
                <div class="col-md-10 offset-md-1">
                    ...
                    <form id="register-form" class="main_form">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input class="contactus" placeholder="Prenom" type="text" name="Prenom">
                            </div>
                            <div class="col-md-6">
                                <input class="contactus" placeholder="Email" type="email" name="Email">
                            </div>
                            <div class="col-md-6">
                                <input class="contactus" placeholder="Mot de passe" type="password" name="Mot de passe">
                            </div>
                            <div class="col-md-6">
                                <input class="contactus" placeholder="Confirmer Mot de passe" type="password" name="Confirmer Mot de passe">
                            </div>
                            <div class="col-md-6">
                                <input class="contactus" placeholder="Contact" type="text" name="Contact">
                            </div>
                            <div class="col-md-12">
                                <button class="send_btn">S'inscrire</button>
                            </div>
                        </div>
                    </form>
                </div>
